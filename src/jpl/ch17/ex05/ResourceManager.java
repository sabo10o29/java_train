...
//			reaper.interrupt();
	...
	public void reaper() {
		...
		Reference<?> ref = queue.poll(); // 参照キューに存在する参照＝もう使用されていないインスタンス
		if (ref == null)
			return;
		Resource res = null;
...
//			while(true){
//				
//				if(shutdown&&refs.isEmpty())break;			//シャットダウンフラグがたち、マップが空の場合に終了
//				//マップクラスrefsに値が存在する限りループを実行する
//				try{
...
//					System.out.println("終了命令が呼び出されました。");
////					break; 
//				}
//				
//				
